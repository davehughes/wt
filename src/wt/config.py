...
class Config:
    ...
    def get_symlinks(self, profile_name: str | None = None) -> dict[Path, Path]:
        """Get symlinks configuration from a profile.
        ...
        Raises:
            ConfigError: If profile not found or symlink target is absolute
        """
        profile = self.get_profile(profile_name)
        symlinks_data = profile.get("symlinks", {})
        symlinks = {}
